...
void XDRGTKRoutine() {
  ...
  if (millis() >= signalstatustimer + 66) {
    ...
    DataPrint(String(((SStatus * 100) + 10875) / 1000) + "." + String(((SStatus * 100) + 10875) / 100 % 10) + "," + String(WAM / 10) + "," + String(USN / 10) + "," + String(BW) + "," + String(SNR) + "," + String(OStatus / 10) + "," + String(MStatus) + "\n\n");
